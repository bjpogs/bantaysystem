...
<body id="page-top">
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="Dashboard.php">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="CertofIndigency.php"><i class="far fa-file-alt"></i><span>Certificate of Indigency</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Certificate of Indigency</h3>
                    <div class="card shadow">
                                    ...
                                    <?php
                                            ...
                                            if ($result->num_rows > 0)
                                            {
                                                while($row = $result->fetch_assoc())
                                                {
                                                    ...
                                                    echo '<td>&nbsp;<div class="form-group" style="margin-bottom: 0px;margin-top: -25px;"><button data-toggle="modal" data-target="#showCertofIndigency" class="btn btn-primary" type="button" style="margin: 5px;margin-left: 5px;" resname="' . $row["resident_fname"] . ' ' . $row["resident_mname"] . ' ' . $row["resident_lname"] . '" resgender="' . $row['resident_gender'] . '" rescivil="' . $row['resident_civilstatus'] . '">Generate</button></div></td>';
                                                    echo "</tr>";
                                                }
                                            }
                                            else
                        ...
                        <div class="card-footer"><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#showCertofIndigency">New Certificate</button></div>
                    </div>
                </div>
            </div>
            <!-- Modal -->
            <div class="modal fade" id="showCertofIndigency" tabindex="-1" data-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Certificate of Indigency</h5>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="coi-name" id="coi-name" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                        <label for="" class="col-form-label">Gender:</label>
                                        <select class="custom-select" name="coi-gender" id="coi-gender">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="coi-civilstatus" id="coi-civilstatus">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="cert-add"class="btn btn-primary">Generate</button>
                            </div>
                    </div>
                </div>
            </div>
    ...
    <script src="assets/js/certofindigency.js"></script>
</body>
